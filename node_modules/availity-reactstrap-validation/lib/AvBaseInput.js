...
var AvBaseInput = function (_Component) {
  ...
  AvBaseInput.prototype.getDefaultValue = function getDefaultValue() {
    ...
    if (this.props.type === 'checkbox') {
      if (!(0, _lodash.isUndefined)(this.props.defaultChecked)) {
  ...
  AvBaseInput.prototype.getFieldValue = function getFieldValue(event) {
    ...
    if (this.props.type === 'select' && this.props.multiple) {
      return [].concat(event.target.options).filter(function (_ref) {
    ...
    return event && event.target && !(0, _lodash.isUndefined)(event.target.value) ? event.target.value : event;
  };
  ...
  AvBaseInput.prototype.getValidatorProps = function getValidatorProps() {
    ...
    var state = this.props.state && this.context.FormCtrl.getInputState(this.props.name);
